...
public interface AttendanceRepository extends JpaRepository<Attendance, Integer> {
    ...
    // Lấy danh sách chấm công của user tại phòng khám trong ngày (cho bác sĩ có
    // nhiều ca)
    ...
    // Lấy danh sách lịch sử chấm công của user trong khoảng thời gian, sắp xếp mới
    // nhất trước
    List<Attendance> findByUserIdAndWorkDateBetweenOrderByWorkDateDesc(
            Integer userId, LocalDate startDate, LocalDate endDate);

    // Lấy danh sách lịch sử chấm công của user trong khoảng thời gian, có phân
    // trang
    ...
    // Lấy lịch sử chấm công của user tại một clinic trong khoảng thời gian, có phân
    // trang
    ...
    List<Attendance> findByClinicIdAndWorkDateAndAttendanceStatus(Integer clinicId, LocalDate workDate,
    ...
    boolean existsByUserIdAndWorkDateWithCheckIn(@Param("userId") Integer userId,
            @Param("workDate") LocalDate workDate);
    ...
    boolean existsByUserIdAndWorkDateWithCheckOut(@Param("userId") Integer userId,
            @Param("workDate") LocalDate workDate);
    ...
    // Lấy danh sách attendance có actualWorkHours trong khoảng thời gian (cho kế
    // toán)
