...
public class HrController {
    ...
    @PostMapping("/create")
    public ResponseEntity<List<DoctorScheduleDto>> createWeeklySchedule(
    ...
    public ResponseEntity<ValidationResultDto> validateSchedule(
            @Valid @RequestBody CreateWeeklyScheduleRequest request) {
    ...
    public ResponseEntity<CreateWeeklyScheduleRequest> generateScheduleFromCustomPrompt(
        ...
        CreateWeeklyScheduleRequest generatedRequest = aiScheduleGenerationService
                .generateScheduleFromCustomPrompt(weekStart, customPrompt);
        return ResponseEntity.ok(generatedRequest);
    }
